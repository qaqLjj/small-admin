    ...
    <el-table class="table" :data="list" border fit highlight-current-row>
      ...
      <el-table-column prop="sex" label="性别" width="80">
        <template slot-scope="scope">
          <el-tag :type="scope.row.sex | sexFilter">{{
            scope.row.sex == 0 ? "男" : "女"
          }}</el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          <el-button
            size="mini"
            type="success"
            @click="editStudentItem(scope.row)"
          >编辑用户</el-button>
          <el-button
            size="mini"
            type="warning"
            @click="addStudentVision(scope.row)"
          >添加视力信息</el-button>
          <el-button
            size="mini"
            type="danger"
      ...
      <el-form ref="form" :model="form" :rules="rules">
        ...
        <el-col :span="8">
          <el-form-item label="班级:" prop="sClass">
            <el-input v-model="form.sClass" type="number" autocomplete="off" />
          </el-form-item>
        </el-col>
      </el-form>
