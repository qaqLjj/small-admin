  ...
  <div class="app-container">
    ...
    <el-table class="table" :data="list" border fit highlight-current-row>
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          <el-button size="mini" @click="editStudentItem(scope.row)">编辑用户</el-button>
          <el-button size="mini" @click="addStudentVision(scope.row)">添加视力信息</el-button>
    ...
    <el-dialog :title="title" :visible.sync="visionFormVisible" width="700px" :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules">
        ...
        <el-col span="12">
          <el-form-item label="年级:" prop="sGroup">
            <el-select v-model="form.sGroup" l placeholder="请选择" :label-width="formLabelWidth" disabled>
              <el-option v-for="item in sGroup" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col span="24">
          <el-form-item label="联系电话:" prop="phone" required>
            <el-input v-model="form.phone" type="number" autocomplete="off" disabled />
          </el-form-item>
        </el-col>

        <el-col span="12">
          <el-form-item label="右眼裸眼" :label-width="formLabelWidth">
            <el-input v-model.Number="vision.rEye" type="number" placeholder="请输入数字" autocomplete="off" />
          </el-form-item>
        </el-col>
        <el-col span="12">
          <el-form-item label="左眼裸眼" :label-width="formLabelWidth">
            <el-input v-model.Number="vision.lEye" type="number" placeholder="请输入数字" autocomplete="off" />
          </el-form-item>
        </el-col>
        <el-col span="12">
          <el-form-item label="右眼屈光" :label-width="formLabelWidth">
            <el-input v-model.Number="vision.rEyeRef" type="number" placeholder="请输入数字" autocomplete="off" />
          </el-form-item>
        </el-col>
        <el-col span="12">
          <el-form-item label="左眼屈光" :span="24">
            <el-input v-model.Number="vision.lEyeRef" type="number" placeholder="请输入数字" autocomplete="off" />
          </el-form-item>
        </el-col>
